        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                ...
                <motion.button
                  ...
                  className="flex items-center justify-center gap-3 bg-gradient-to-r from-amber-400 to-orange-500 text-white text-xl font-bold py-4 px-8 rounded-2xl shadow-lg shadow-amber-200"
                >
          ...
          {view === 'highscores' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0, scale: 1 }}
              exit={{ opacity: 0, y: -20, scale: 0.9 }}
              className="max-w-lg w-full bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 text-center"
            >
